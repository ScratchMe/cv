...
- **Débuts repliés** : `CONFIG.collapseRolesEndingBefore = "2016-08"` replie sur le site les rôles terminés à cette date ou avant (QA 2015-2016, ESN 2011-2015) derrière un bouton « Voir mes débuts (2011 – 2016) → ». Ils restent dans la page (indexables), se déroulent au clic ou dès qu'un filtre de compétence est actif, et le PDF les montre toujours. Mets `null` pour tout afficher. Sur téléphone, les tags par rôle n'apparaissent qu'avec un filtre actif (ils répètent la section Compétences).
